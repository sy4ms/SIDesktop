...
public class form_entry_mahasiswa extends javax.swing.JDialog {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int ok=JOptionPane.showConfirmDialog(null,"Apakah Anda yakin ingin menghapus data Mahasiswa BP : "
                +no_bp+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
        if(ok==0){
            try{
    ...
    private void bnt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnt_updateActionPerformed
        ...
        tanggal_masuk = t_tgl_lahir.getText();
        tanggal_lahir = t_tgl_lahir.getText();
        if (tanggal_lahir==null){
            JOptionPane.showMessageDialog(null, "Silahkan isi TANGGAL LAHIR","Informasi", 
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else if (tanggal_masuk==null){
            JOptionPane.showMessageDialog(null, "Silahkan isi TANGGAL MASUK","Informasi", 
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else {
            String sql="update tb_mahasiswa set nama=?, tempat_lahir=?, tanggal_lahir=?, "
                    + "jurusan=?, tanggal_masuk=? where no_bp='"+no_bp+"'";
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        String no_bp="", nama="", tempat_lahir="",  tanggal_lahir, jurusan="", tanggal_masuk;
        ...
        try {
            ...
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null, "Menyimpan data BERHASIL","Informasi", 
                    JOptionPane.INFORMATION_MESSAGE);
       
            tampil_tb_mahasiswa();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Menyimpan data GAGAL","Informasi", 
                    JOptionPane.INFORMATION_MESSAGE);
        }
